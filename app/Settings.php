				...
				'suffix_master_tools'	=> [
					...
					'fields'    => [
						'live_preview' => [
							...
							'type'      => 'switch',
							'desc'      => __( 'Enable live preview to see suffix changes in real-time as you type. Toggle this on to see a preview box at the top of the settings page.', 'suffix-master' ),
							'default'   => 'off',
						],
						'reset_all_button' => [
							'id'        => 'reset_all_button',
							...
							'type'      => 'text',
							'desc'      => __( 'This will clear all suffix settings and restore defaults. This action cannot be undone.', 'suffix-master' ) . '<br><br><button type="button" id="suffix-master-reset-all" class="button button-secondary" style="color: #d63638; border-color: #d63638;">' . __( 'Reset All Settings', 'suffix-master' ) . '</button>',
							'default'   => '',
							'placeholder' => __( 'Click the button below to reset all settings', 'suffix-master' ),
							'readonly'  => true,
